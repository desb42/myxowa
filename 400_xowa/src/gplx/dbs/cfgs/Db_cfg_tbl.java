...
//            System.out.println("str_or " + grp + " " + key + ":" + or);
	...
	private Err			err_parse(Exception e, String grp, String key, String val, String type) {
            return Err_.new_exc(e, "db", "cfg.val is not parseable", "grp", grp, "key", key, "val", val, "type", type);}
