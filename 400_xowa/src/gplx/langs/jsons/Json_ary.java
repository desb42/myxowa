...
public class Json_ary extends Json_itm_base implements Json_grp {
	private Json_ary(int size) { // preallocate subs array
	...
	public static Json_ary NewByDoc(Json_doc doc, int src_bgn, int src_end, int size) {return new Json_ary(size);}
