...
public class Xoh_head_mgr implements gplx.core.brys.Bfr_arg {
	...
	public Xoh_head_itm__gallery_slideshow		Itm__gallery_slideshow() {return itm__gallery_slideshow;} private final    Xoh_head_itm__gallery_slideshow itm__gallery_slideshow = new Xoh_head_itm__gallery_slideshow();
	...
	public void Write(Bry_bfr bfr, Xoae_app app, Xowe_wiki wiki, Xoae_page page) {
		...
		if (app.Mode().Tid_is_http()) {
			...
			//	wtr.Write_js_include(Bry_.new_a7(app.Fsys_mgr().Bin_any_dir().GenSubFil_nest("xowa", "html", "res", "lib", "google-code-prettify").To_http_file_str() + "/run_prettify.js?lang=lua"));
		}
