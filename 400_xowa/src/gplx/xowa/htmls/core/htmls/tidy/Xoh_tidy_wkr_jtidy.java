...
//		tidy.setShowErrors(0);					// NOTE: otherwise errors printed to output window; EX: Error: <time> is not recognized!
		tidy.setShowWarnings(true);			// NOTE: otherwise warnings printed to output window
		tidy.setShowErrors(1);					// NOTE: otherwise errors printed to output window; EX: Error: <time> is not recognized!
