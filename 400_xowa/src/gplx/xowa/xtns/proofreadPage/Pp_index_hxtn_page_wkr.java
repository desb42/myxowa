...
public class Pp_index_hxtn_page_wkr implements Hxtn_page_wkr {
	private final Hxtn_blob_tbl page_text_tbl;
	public int Id() {return Hxtn_page_mgr.Id__pgbnr;}
	public String Key() {return KEY;}
	public Pp_index_hxtn_page_wkr(Hxtn_blob_tbl page_text_tbl) {
		this.page_text_tbl = page_text_tbl;
	}
	public void Load_by_page(Xoh_page hpg, Xoa_ttl ttl, int page_id) {
		byte[] data = page_text_tbl.Select_text(Hxtn_blob_tbl.Blob_tid__wtxt, Hxtn_page_mgr.Id__pp_indexpage, page_id);
		hpg.Props().Add(KEY, data);
	}
	public static final String KEY = "xowa.xtns.pp_indexpage";
}