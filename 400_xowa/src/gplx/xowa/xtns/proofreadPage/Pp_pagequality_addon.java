...
public class Pp_pagequality_addon implements Xoax_addon_itm, Xoax_addon_itm__init {
	public void Init_addon_by_app(Xoa_app app) {}
	public void Init_addon_by_wiki(Xow_wiki wiki) {
		wiki.Hxtn_mgr().Reg_wkr(new Pp_quality_hxtn_page_wkr(wiki.Hxtn_mgr().Blob_tbl()));
	}
