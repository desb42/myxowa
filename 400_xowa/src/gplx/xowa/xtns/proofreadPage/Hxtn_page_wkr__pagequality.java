...
public class Hxtn_page_wkr__pagequality implements Hxtn_page_wkr {
	private final    Hxtn_blob_tbl page_text_tbl;
	public int Id() {return Hxtn_page_mgr.Id__pp_pagequality;}
	public String Key() {return "xowa.xtns.pp_pagequality";}
	public Hxtn_page_wkr__pagequality(Hxtn_blob_tbl page_text_tbl) {
