...
public class Pfunc_yesno_yes extends Pf_func_base {
	@Override public int Id() {return Xol_kwd_grp_.Id_yesno_yes;}
	@Override public Pf_func New(int id, byte[] name) {return new Pfunc_yesno_yes().Name_(name);}
	...
	@Override public void Func_evaluate(Bry_bfr bfr, Xop_ctx ctx, Xot_invk caller, Xot_invk self, byte[] src) { // hard coding of Template:yesno
		Pfunc_yesno.Process_yesno(bfr, ctx, caller, self, src, Pfunc_yesno.YESYES);
	}
}
