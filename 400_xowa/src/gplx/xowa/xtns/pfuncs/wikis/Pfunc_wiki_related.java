...
public class Pfunc_wiki_related extends Pf_func_base {
	...
	@Override public Pf_func New(int id, byte[] name) {return new Pfunc_wiki_related(id).Name_(name);}
	public static final    Pfunc_wiki_related Instance = new Pfunc_wiki_related(-1);
}
