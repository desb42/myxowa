...
public class Pfunc_scrib_lib implements Scrib_lib {
	...
	public Scrib_lua_mod Register(Scrib_core core, Io_url script_dir) {
		this.core = core;
		Init();
		mod = core.RegisterInterface(this, "mw.ext.ParserFunctions.lua", core.Core_mgr().Get_text(core.App().Fsys_mgr().Bin_xtns_dir().GenSubDir_nest("ParserFunctions"), "mw.ext.ParserFunctions.lua"));
