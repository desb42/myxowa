...
case 0:
	s.yyaccept = 0;
	if ((s.lim - s.cursor) < 33) return EOI; // ((YYLIMIT - YYCURSOR) < 33) YYFILL(33);
...
//{
	...
	case '\n':	s.state = 2; break;
	case '\t':
	case ' ':	s.state = 6; break;
	case '(':	s.state = 8; break;
	case '+':
	case '-':	s.state = 9; break;
	case ',':
	case '.':	s.state = 10; break;
	case '0':	s.state = 11; break;
	case '1':	s.state = 12; break;
	case '2':	s.state = 13; break;
	case '3':	s.state = 14; break;
	case '4':
	case '5':
	case '6':
	case '7':
	case '8':
	case '9':	s.state = 15; break;
	case '@':	s.state = 16; break;
	case 'A':	s.state = 17; break;
	case 'B':	s.state = 19; break;
	case 'C':
	case 'H':
	case 'K':
	case 'Q':
	case 'R':
	case 'U':
	case 'Z':	s.state = 20; break;
	case 'D':	s.state = 21; break;
	case 'E':	s.state = 22; break;
	case 'F':	s.state = 23; break;
	case 'G':	s.state = 24; break;
	case 'I':	s.state = 25; break;
	case 'J':	s.state = 26; break;
	case 'L':	s.state = 27; break;
	case 'M':	s.state = 28; break;
	case 'N':	s.state = 29; break;
	case 'O':	s.state = 30; break;
	case 'P':	s.state = 31; break;
	case 'S':	s.state = 32; break;
	case 'T':	s.state = 33; break;
	case 'V':	s.state = 34; break;
	case 'W':	s.state = 35; break;
	case 'X':	s.state = 36; break;
	case 'Y':	s.state = 37; break;
	case 'a':	s.state = 38; break;
	case 'b':	s.state = 39; break;
	case 'c':
	case 'g':
	case 'h':
	case 'i':
	...
	case 'v':
	case 'x':
	case 'z':	s.state = 40; break;
	case 'd':	s.state = 41; break;
	case 'e':	s.state = 42; break;
	case 'f':	s.state = 43; break;
	case 'j':	s.state = 44; break;
	case 'l':	s.state = 45; break;
	case 'm':	s.state = 46; break;
	case 'n':	s.state = 47; break;
	case 'o':	s.state = 48; break;
	case 'p':	s.state = 49; break;
	case 's':	s.state = 50; break;
	case 't':	s.state = 51; break;
	case 'w':	s.state = 52; break;
	case 'y':	s.state = 53; break;
	default:	s.state = 4; break;
	}
...
case 57:
	++s.cursor;
	if ((s.lim - s.cursor) < 12) return EOI;
	case57(s);
	break;
case 59:
	++s.cursor;
...
case 65:
	++s.cursor;
	if ((s.lim - s.cursor) < 13) return EOI;
...
case 106:
	s.yyaccept = 4;
	s.ptr = ++s.cursor;
	if ((s.lim - s.cursor) < 7) return EOI;
	case106(s);
	break;
case 108:
...
case 135:
	++s.cursor;
	if ((s.lim - s.cursor) < 23) return EOI;
	s.yych = s.src[s.cursor];
...
case 238:
	++s.cursor;
	if ((s.lim - s.cursor) < 4) return EOI;
	case238(s);
	break;
case 240:
	case240(s);
...
case 311:
	s.yyaccept = 11;
	s.ptr = ++s.cursor;
	if ((s.lim - s.cursor) < 18) return EOI;
	s.yych = s.src[s.cursor];
...
case 492:
	s.yyaccept = 11;
	s.ptr = ++s.cursor; s.yych = s.src[s.cursor];
	if (s.yych <= 0x00) if (s.yych <= 0x00) { s.state = 309; break; }
	s.state = 312; break;
...
case 616:
	++s.cursor;
	if ((s.lim - s.cursor) < 5) return EOI;
	case616(s);
	break;
case 618:
	case618(s);
...
case 721:
	++s.cursor;
	if ((s.lim - s.cursor) < 9) return EOI;
	s.yych = s.src[s.cursor];
...
case 1095:
	++s.cursor;
	if ((s.lim - s.cursor) < 2) return EOI;
	case1095(s);
	break;
case 1097:
	case1097(s);
...
case 1273:
	...
	switch (s.yych) {
	case '+':
	case '-':	s.state = 1262; break;
	default:	s.state = 56; break;
	}
}
...
private static void case6(Dbx_scanner s) {
	...
	case '7':
	case '8':
	case '9':	s.state = 57; break;
	default:	s.state = 7; break;
	}
}
...
private static void case9(Dbx_scanner s) {
	...
	case '0':
	case '1':	s.state = 61; break;
	case '2':	s.state = 62; break;
	case '3':
	case '4':
	case '5':
	case '6':
...
private static void case11(Dbx_scanner s) {
	...
	case 'w':
	case 'y':
	case 0xC2:	s.state = 66; break;
	case '-':	s.state = 67; break;
	case '.':	s.state = 68; break;
	case '/':	s.state = 69; break;
	case '0':	s.state = 70; break;
	case '1':
	case '2':
	case '3':
	case '4':
	...
	case '7':
	case '8':
	case '9':	s.state = 71; break;
	case ':':	s.state = 72; break;
	case 'n':	s.state = 90; break;
	case 'r':	s.state = 91; break;
	case 's':	s.state = 92; break;
	case 't':	s.state = 93; break;
	default:	s.state = 5; break;
	}
}
...
private static void case12(Dbx_scanner s) {
	...
	case 'w':
	case 'y':
	case 0xC2:	s.state = 97; break;
	case '-':	s.state = 67; break;
	case '.':	s.state = 98; break;
	case '/':	s.state = 69; break;
	case '0':
	case '1':
	case '2':	s.state = 71; break;
	case '3':
	case '4':
	case '5':
	case '6':
...
private static void case13(Dbx_scanner s) {
	...
	case '2':
	case '3':
	case '4':	s.state = 99; break;
	case '5':
	case '6':
	case '7':
	case '8':
	case '9':	s.state = 103; break;
	case ':':	s.state = 100; break;
	case 'n':	s.state = 90; break;
	case 'r':	s.state = 91; break;
	case 's':	s.state = 92; break;
...
private static void case17(Dbx_scanner s) {
	...
	case 'X':
	case 'Y':
	case 'Z':	s.state = 110; break;
	case 'G':	s.state = 111; break;
	case 'P':	s.state = 112; break;
	case 'U':	s.state = 113; break;
	case 'a':
	case 'b':
	case 'c':
	case 'd':
	...
	case 'x':
	case 'y':
	case 'z':	s.state = 114; break;
	case 'g':	s.state = 115; break;
	case 'p':	s.state = 116; break;
	case 'u':	s.state = 117; break;
	default:	s.state = 18; break;
	}
}
...
private static void case22(Dbx_scanner s) {
	...
	case 'Y':
	case 'Z':	s.state = 110; break;
	case 'I':	s.state = 122; break;
	case 'L':	s.state = 123; break;
	case 'a':
	case 'b':
	case 'c':
	case 'd':
	...
	case 'y':
	case 'z':	s.state = 114; break;
	case 'i':	s.state = 124; break;
	case 'l':	s.state = 125; break;
	default:	s.state = 18; break;
	}
}
...
private static void case23(Dbx_scanner s) {
	...
	case 'Y':
	case 'Z':	s.state = 110; break;
	case 'E':	s.state = 126; break;
	case 'I':	s.state = 127; break;
	case 'O':	s.state = 128; break;
	case 'R':	s.state = 129; break;
	case 'a':
	case 'b':
	case 'c':
	case 'd':
	...
	case 'y':
	case 'z':	s.state = 114; break;
	case 'e':	s.state = 130; break;
	case 'i':	s.state = 131; break;
	case 'o':	s.state = 132; break;
	case 'r':	s.state = 133; break;
	default:	s.state = 18; break;
	}
}
...
private static void case25(Dbx_scanner s) {
	...
	case 'Y':
	case 'Z':	s.state = 110; break;
	case 'I':	s.state = 140; break;
	case 'V':
	case 'X':	s.state = 141; break;
	case 'a':
	case 'b':
	case 'c':
	case 'd':
...
private static void case26(Dbx_scanner s) {
	...
	case 'Y':
	case 'Z':	s.state = 110; break;
	case 'U':	s.state = 143; break;
	case 'a':	s.state = 144; break;
	case 'b':
	case 'c':
	case 'd':
	case 'e':
...
private static void case28(Dbx_scanner s) {
	...
	case 'Y':
	case 'Z':	s.state = 110; break;
	case 'I':	s.state = 149; break;
	case 'O':	s.state = 150; break;
	case 'a':	s.state = 151; break;
	case 'b':
	case 'c':
	case 'd':
	case 'e':
	...
	case 'y':
	case 'z':	s.state = 114; break;
	case 'i':	s.state = 152; break;
	case 'o':	s.state = 153; break;
	default:	s.state = 18; break;
	}
}
...
private static void case29(Dbx_scanner s) {
	...
	case 'Y':
	case 'Z':	s.state = 110; break;
	case 'E':	s.state = 154; break;
	case 'I':	s.state = 155; break;
	case 'O':	s.state = 156; break;
	case 'a':
	case 'b':
	case 'c':
	case 'd':
	...
	case 'y':
	case 'z':	s.state = 114; break;
	case 'e':	s.state = 157; break;
	case 'i':	s.state = 158; break;
	case 'o':	s.state = 159; break;
	default:	s.state = 18; break;
	}
}
...
private static void case32(Dbx_scanner s) {
	...
	case 'Y':
	case 'Z':	s.state = 110; break;
	case 'E':	s.state = 165; break;
	case 'I':	s.state = 166; break;
	case 'U':	s.state = 150; break;
	case 'a':	s.state = 167; break;
	case 'b':
	case 'c':
	case 'd':
	case 'f':
	...
	case 'y':
	case 'z':	s.state = 114; break;
	case 'e':	s.state = 168; break;
	case 'i':	s.state = 169; break;
	case 'u':	s.state = 153; break;
	default:	s.state = 18; break;
	}
}
...
private static void case33(Dbx_scanner s) {
	...
	case ')':	s.state = 109; break;
	case '0':
	case '1':	s.state = 170; break;
	case '2':	s.state = 171; break;
	case '3':
	case '4':
	case '5':
	case '6':
	...
	case 'Y':
	case 'Z':	s.state = 110; break;
	case 'E':	s.state = 155; break;
	case 'H':	s.state = 173; break;
	case 'O':	s.state = 174; break;
	case 'U':	s.state = 175; break;
	case 'W':	s.state = 176; break;
	case 'a':
	case 'b':
	case 'c':
	case 'd':
	...
	case 'y':
	case 'z':	s.state = 114; break;
	case 'e':	s.state = 158; break;
	case 'h':	s.state = 177; break;
	case 'o':	s.state = 178; break;
	case 'u':	s.state = 179; break;
	case 'w':	s.state = 180; break;
	default:	s.state = 18; break;
	}
}
...
private static void case56(Dbx_scanner s) {
	s.cursor = s.ptr;
	switch (s.yyaccept) {
	case 0: 	s.state = 7; break;
	case 1: 	s.state = 5; break;
	case 2: 	s.state = 18; break;
	case 3: 	s.state = 78; break;
	case 4: 	s.state = 108; break;
	case 5: 	s.state = 209; break;
	case 6: 	s.state = 214; break;
	case 7: 	s.state = 250; break;
	case 8: 	s.state = 280; break;
	case 9: 	s.state = 278; break;
	case 10: 	s.state = 300; break;
	case 11: 	s.state = 310; break;
	case 12: 	s.state = 336; break;
	case 13: 	s.state = 401; break;
	case 14: 	s.state = 403; break;
	case 15: 	s.state = 505; break;
	case 16: 	s.state = 545; break;
	case 17: 	s.state = 696; break;
	case 18: 	s.state = 711; break;
	case 19: 	s.state = 724; break;
	case 20: 	s.state = 747; break;
	case 21: 	s.state = 814; break;
	case 22: 	s.state = 886; break;
	case 23: 	s.state = 577; break;
	case 24: 	s.state = 901; break;
	case 25: 	s.state = 935; break;
	case 26: 	s.state = 973; break;
	case 27: 	s.state = 991; break;
	case 28: 	s.state = 996; break;
	case 29: 	s.state = 1049; break;
	case 30: 	s.state = 1085; break;
	case 31: 	s.state = 1108; break;
	case 32: 	s.state = 1111; break;
	default:	s.state = 1228; break;
	}
}
...
private static void case57(Dbx_scanner s) {
	...
	case '9':	s.state = 57; break;
	case 'D':
	case 'd':	s.state = 188; break;
	case 'F':
	case 'f':	s.state = 189; break;
	case 'H':
	case 'h':	s.state = 76; break;
	case 'M':
	case 'm':	s.state = 190; break;
	case 'S':
	case 's':	s.state = 191; break;
	case 'T':
	case 't':	s.state = 84; break;
	case 'U':
	case 'u':	s.state = 85; break;
	case 'W':
	case 'w':	s.state = 87; break;
	case 'Y':
	case 'y':	s.state = 89; break;
	case 0xC2:	s.state = 94; break;
	default:	s.state = 56; break;
	}
}
...
private static void case61(Dbx_scanner s) {
	...
	case '7':
	case '8':
	case '9':	s.state = 192; break;
	case ':':	s.state = 193; break;
	default:	s.state = 18; break;
	}
}
...
private static void case62(Dbx_scanner s) {
	...
	case '2':
	case '3':
	case '4':	s.state = 192; break;
	case '5':	s.state = 194; break;
	case '6':
	case '7':
	case '8':
	case '9':	s.state = 195; break;
	case ':':	s.state = 193; break;
	default:	s.state = 18; break;
	}
}
...
private static void case64(Dbx_scanner s) {
	s.yych = s.src[++s.cursor];
	switch (s.yych) {
	case '0':	s.state = 198; break;
	case '1':	s.state = 199; break;
	case '2':
	case '3':
	case '4':
	case '5':
	...
	case '7':
	case '8':
	case '9':	s.state = 200; break;
	default:	s.state = 66; break;
	}
}
...
private static void case66(Dbx_scanner s) {
	switch (s.yych) {
	case '\t':
	case ' ':	s.state = 65; break;
	case '-':
	case '.':	s.state = 196; break;
	case 'A':
	case 'a':	s.state = 73; break;
	case 'D':
	case 'd':	s.state = 74; break;
	case 'F':
	case 'f':	s.state = 75; break;
	case 'H':
	case 'h':	s.state = 76; break;
	case 'I':	s.state = 77; break;
	case 'J':
	case 'j':	s.state = 79; break;
	case 'M':
	case 'm':	s.state = 80; break;
	case 'N':
	case 'n':	s.state = 81; break;
	case 'O':
	case 'o':	s.state = 82; break;
	case 'S':
	case 's':	s.state = 83; break;
	case 'T':
	case 't':	s.state = 84; break;
	case 'U':
	case 'u':	s.state = 85; break;
	case 'V':	s.state = 86; break;
	case 'W':
	case 'w':	s.state = 87; break;
	case 'X':	s.state = 88; break;
	case 'Y':
	case 'y':	s.state = 89; break;
	case 0xC2:	s.state = 94; break;
	default:	s.state = 56; break;
...
private static void case67(Dbx_scanner s) {
	s.yych = s.src[++s.cursor];
	switch (s.yych) {
	case '0':	s.state = 201; break;
	case '1':	s.state = 202; break;
	case '2':
	case '3':
	case '4':
	case '5':
	...
	case '7':
	case '8':
	case '9':	s.state = 203; break;
	default:	s.state = 197; break;
	}
}
...
private static void case68(Dbx_scanner s) {
	s.yych = s.src[++s.cursor];
	switch (s.yych) {
	case '0':	s.state = 208; break;
	case '1':	s.state = 210; break;
	case '2':
	case '3':
	case '4':
	case '5':	s.state = 211; break;
	case '6':
	case '7':
	case '8':
	case '9':	s.state = 212; break;
	default:	s.state = 197; break;
	}
}
...
private static void case69(Dbx_scanner s) {
	...
	case '0':
	case '1':
	case '2':	s.state = 213; break;
	case '3':	s.state = 215; break;
	case '4':
	case '5':
	case '6':
	case '7':
	case '8':
	case '9':	s.state = 216; break;
	case 'A':
	case 'a':	s.state = 217; break;
	case 'D':
	case 'd':	s.state = 218; break;
	case 'F':
	case 'f':	s.state = 219; break;
	case 'J':
	case 'j':	s.state = 220; break;
	case 'M':
	case 'm':	s.state = 221; break;
	case 'N':
	case 'n':	s.state = 222; break;
	case 'O':
	case 'o':	s.state = 223; break;
	case 'S':
	case 's':	s.state = 224; break;
	default:	s.state = 56; break;
	}
}
...
private static void case70(Dbx_scanner s) {
	...
	case '3':
	case '4':
	case '5':	s.state = 226; break;
	case '6':
	case '7':
	case '8':
	case '9':	s.state = 227; break;
	case ':':	s.state = 72; break;
	case 'n':	s.state = 90; break;
	case 'r':	s.state = 91; break;
	case 's':	s.state = 92; break;
...
private static void case72(Dbx_scanner s) {
	...
	case '3':
	case '4':
	case '5':	s.state = 228; break;
	case '6':
	case '7':
	case '8':
	case '9':	s.state = 229; break;
	default:	s.state = 56; break;
	}
}
...
private static void case73(Dbx_scanner s) {
	...
	switch (s.yych) {
	case 'P':
	case 'p':	s.state = 230; break;
	case 'U':
	case 'u':	s.state = 231; break;
	default:	s.state = 56; break;
	}
}
...
private static void case74(Dbx_scanner s) {
	...
	switch (s.yych) {
	case 'A':
	case 'a':	s.state = 232; break;
	case 'E':
	case 'e':	s.state = 233; break;
	default:	s.state = 56; break;
	}
}
...
private static void case75(Dbx_scanner s) {
	...
	switch (s.yych) {
	case 'E':
	case 'e':	s.state = 234; break;
	case 'O':
	case 'o':	s.state = 235; break;
	case 'R':
	case 'r':	s.state = 236; break;
	default:	s.state = 56; break;
	}
}
...
private static void case77(Dbx_scanner s) {
	...
	case '7':
	case '8':
	case '9':	s.state = 240; break;
	case 'I':	s.state = 242; break;
	case 'V':
	case 'X':	s.state = 243; break;
	default:	s.state = 78; break;
	}
}
...
private static void case79(Dbx_scanner s) {
	...
	switch (s.yych) {
	case 'A':
	case 'a':	s.state = 244; break;
	case 'U':
	case 'u':	s.state = 245; break;
	default:	s.state = 56; break;
	}
}
...
private static void case80(Dbx_scanner s) {
	...
	switch (s.yych) {
	case 'A':
	case 'a':	s.state = 246; break;
	case 'I':
	case 'i':	s.state = 247; break;
	case 'O':
	case 'o':	s.state = 248; break;
	case 'S':
	case 's':	s.state = 249; break;
	default:	s.state = 56; break;
	}
}
...
private static void case83(Dbx_scanner s) {
	...
	switch (s.yych) {
	case 'A':
	case 'a':	s.state = 253; break;
	case 'E':
	case 'e':	s.state = 254; break;
	case 'U':
	case 'u':	s.state = 255; break;
	default:	s.state = 56; break;
	}
}
...
private static void case84(Dbx_scanner s) {
	...
	switch (s.yych) {
	case 'H':
	case 'h':	s.state = 256; break;
	case 'U':
	case 'u':	s.state = 257; break;
	default:	s.state = 56; break;
	}
}
...
private static void case97(Dbx_scanner s) {
	switch (s.yych) {
	case '\t':
	case ' ':	s.state = 96; break;
	case '-':
	case '.':	s.state = 196; break;
	case 'A':
	case 'a':	s.state = 101; break;
	case 'D':
	case 'd':	s.state = 74; break;
	case 'F':
	case 'f':	s.state = 75; break;
...
private static void case98(Dbx_scanner s) {
	s.yych = s.src[++s.cursor];
	switch (s.yych) {
	case '0':	s.state = 264; break;
	case '1':	s.state = 265; break;
	case '2':
	case '3':
	case '4':
	case '5':	s.state = 266; break;
	case '6':
	case '7':
	case '8':
	case '9':	s.state = 267; break;
	default:	s.state = 197; break;
	}
}
...
private static void case100(Dbx_scanner s) {
	...
	case '3':
	case '4':
	case '5':	s.state = 269; break;
	case '6':
	case '7':
	case '8':
	case '9':	s.state = 270; break;
	default:	s.state = 56; break;
	}
}
...
private static void case101(Dbx_scanner s) {
	s.yych = s.src[++s.cursor];
	switch (s.yych) {
	case '.':	s.state = 271; break;
	case 'M':
	case 'm':	s.state = 272; break;
	case 'P':
	case 'p':	s.state = 230; break;
	case 'U':
	case 'u':	s.state = 231; break;
...
private static void case127(Dbx_scanner s) {
	...
	case 'z':	s.state = 276; break;
	case 'F':
	case 'f':	s.state = 296; break;
	case 'R':
	case 'r':	s.state = 297; break;
	default:	s.state = 18; break;
	}
}
...
private static void case129(Dbx_scanner s) {
	...
	case 'z':	s.state = 276; break;
	case 'I':
	case 'i':	s.state = 299; break;
	case 'O':
	case 'o':	s.state = 301; break;
	default:	s.state = 18; break;
	}
}
...
private static void case131(Dbx_scanner s) {
	...
	case 'y':
	case 'z':	s.state = 283; break;
	case 'f':	s.state = 303; break;
	case 'r':	s.state = 304; break;
	default:	s.state = 18; break;
	}
}
...
private static void case133(Dbx_scanner s) {
	...
	case 'y':
	case 'z':	s.state = 283; break;
	case 'i':	s.state = 306; break;
	case 'o':	s.state = 307; break;
	default:	s.state = 18; break;
	}
}
...
private static void case136(Dbx_scanner s) {
	...
	case ' ':
	case '-':
	case '.':	s.state = 135; break;
	case '0':
	case '1':
	case '2':	s.state = 137; break;
	case '3':	s.state = 138; break;
	case '4':
	case '5':
	case '6':
	case '7':
	case '8':
	case '9':	s.state = 139; break;
	default:	s.state = 56; break;
	}
}
...
private static void case137(Dbx_scanner s) {
	s.yych = s.src[++s.cursor];
	switch (s.yych) {
	case 0x00:	s.state = 309; break;
	case '\t':
	case ' ':
	case ',':
	case '.':
	case 'd':
	case 'h':	s.state = 311; break;
	case '0':
	case '1':
	case '2':
	case '3':
	...
	case '7':
	case '8':
	case '9':	s.state = 313; break;
	case 'n':
	case 'r':	s.state = 314; break;
	case 's':	s.state = 315; break;
	case 't':	s.state = 316; break;
	default:	s.state = 56; break;
	}
}
...
private static void case143(Dbx_scanner s) {
	...
	case 'z':	s.state = 276; break;
	case 'L':
	case 'l':	s.state = 320; break;
	case 'N':
	case 'n':	s.state = 321; break;
	default:	s.state = 18; break;
	}
}
...
private static void case145(Dbx_scanner s) {
	...
	case 'y':
	case 'z':	s.state = 283; break;
	case 'l':	s.state = 323; break;
	case 'n':	s.state = 324; break;
	default:	s.state = 18; break;
	}
}
...
private static void case148(Dbx_scanner s) {
	...
	case 'z':	s.state = 276; break;
	case 'R':
	case 'r':	s.state = 327; break;
	case 'Y':
	case 'y':	s.state = 328; break;
	default:	s.state = 18; break;
	}
}
...
private static void case151(Dbx_scanner s) {
	...
	case 'x':
	case 'z':	s.state = 283; break;
	case 'r':	s.state = 330; break;
	case 'y':	s.state = 331; break;
	default:	s.state = 18; break;
	}
}
...
private static void case156(Dbx_scanner s) {
	...
	case 'z':	s.state = 276; break;
	case 'O':
	case 'o':	s.state = 334; break;
	case 'V':
	case 'v':	s.state = 289; break;
	case 'W':
	case 'w':	s.state = 335; break;
	default:	s.state = 18; break;
	}
}
...
private static void case159(Dbx_scanner s) {
	...
	case 'y':
	case 'z':	s.state = 283; break;
	case 'o':	s.state = 338; break;
	case 'v':	s.state = 290; break;
	case 'w':	s.state = 339; break;
	default:	s.state = 18; break;
	}
}
...
private static void case165(Dbx_scanner s) {
	...
	case 'z':	s.state = 276; break;
	case 'C':
	case 'c':	s.state = 345; break;
	case 'P':
	case 'p':	s.state = 346; break;
	case 'V':
	case 'v':	s.state = 347; break;
	default:	s.state = 18; break;
	}
}
...
private static void case168(Dbx_scanner s) {
	...
	case 'y':
	case 'z':	s.state = 283; break;
	case 'c':	s.state = 349; break;
	case 'p':	s.state = 350; break;
	case 'v':	s.state = 351; break;
	default:	s.state = 18; break;
	}
}
...
private static void case173(Dbx_scanner s) {
	...
	case 'z':	s.state = 276; break;
	case 'I':
	case 'i':	s.state = 353; break;
	case 'U':
	case 'u':	s.state = 354; break;
	default:	s.state = 18; break;
	}
}
...
private static void case174(Dbx_scanner s) {
	...
	case 'z':	s.state = 276; break;
	case 'D':
	case 'd':	s.state = 355; break;
	case 'M':
	case 'm':	s.state = 356; break;
	default:	s.state = 18; break;
	}
}
...
private static void case177(Dbx_scanner s) {
	...
	case 'y':
	case 'z':	s.state = 283; break;
	case 'i':	s.state = 359; break;
	case 'u':	s.state = 360; break;
	default:	s.state = 18; break;
	}
}
...
private static void case178(Dbx_scanner s) {
	...
	case 'y':
	case 'z':	s.state = 283; break;
	case 'd':	s.state = 361; break;
	case 'm':	s.state = 362; break;
	default:	s.state = 18; break;
	}
}
...
private static void case182(Dbx_scanner s) {
	...
	case 'z':	s.state = 276; break;
	case 'D':
	case 'd':	s.state = 366; break;
	case 'E':
	case 'e':	s.state = 367; break;
	default:	s.state = 18; break;
	}
}
...
private static void case183(Dbx_scanner s) {
	...
	case 'y':
	case 'z':	s.state = 283; break;
	case 'd':	s.state = 368; break;
	case 'e':	s.state = 369; break;
	default:	s.state = 18; break;
	}
}
...
private static void case192(Dbx_scanner s) {
	...
	case '3':
	case '4':
	case '5':	s.state = 373; break;
	case '6':
	case '7':
	case '8':
	case '9':	s.state = 374; break;
	case ':':	s.state = 193; break;
	default:	s.state = 18; break;
	}
}
...
private static void case193(Dbx_scanner s) {
	...
	case '3':
	case '4':
	case '5':	s.state = 375; break;
	case '6':
	case '7':
	case '8':
	case '9':	s.state = 109; break;
	default:	s.state = 18; break;
	}
}
...
private static void case197(Dbx_scanner s) {
	...
	case 'a':	s.state = 73; break;
	case 'D':
	case 'd':	s.state = 204; break;
	case 'F':
	case 'f':	s.state = 205; break;
	case 'I':	s.state = 77; break;
	case 'J':
	case 'j':	s.state = 79; break;
	case 'M':
	case 'm':	s.state = 206; break;
	case 'N':
	case 'n':	s.state = 81; break;
	case 'O':
	case 'o':	s.state = 82; break;
	case 'S':
	case 's':	s.state = 207; break;
	case 'V':	s.state = 86; break;
	case 'X':	s.state = 88; break;
	default:	s.state = 56; break;
	}
...
private static void case198(Dbx_scanner s) {
	s.yych = s.src[++s.cursor];
	switch (s.yych) {
	case '-':	s.state = 377; break;
	case '.':	s.state = 378; break;
	case '0':
	case '1':
	case '2':
	case '3':
...
private static void case208(Dbx_scanner s) {
	...
	case '8':
	case '9':	s.state = 212; break;
	case ':':	s.state = 382; break;
	default:	s.state = 209; break;
	}
}
...
private static void case213(Dbx_scanner s) {
	...
	case '9':	s.state = 216; break;
	case 'n':
	case 'r':	s.state = 384; break;
	case 's':	s.state = 385; break;
	case 't':	s.state = 386; break;
	default:	s.state = 214; break;
	}
}
...
private static void case217(Dbx_scanner s) {
	...
	switch (s.yych) {
	case 'P':
	case 'p':	s.state = 387; break;
	case 'U':
	case 'u':	s.state = 388; break;
	default:	s.state = 56; break;
	}
}
...
private static void case220(Dbx_scanner s) {
	...
	switch (s.yych) {
	case 'A':
	case 'a':	s.state = 391; break;
	case 'U':
	case 'u':	s.state = 392; break;
	default:	s.state = 56; break;
	}
}
...
private static void case225(Dbx_scanner s) {
	s.yych = s.src[++s.cursor];
	switch (s.yych) {
	case '0':	s.state = 397; break;
	case '1':	s.state = 398; break;
	case '2':
	case '3':
	case '4':
	case '5':
...
private static void case240(Dbx_scanner s) {
	...
	case '7':
	case '8':
	case '9':	s.state = 412; break;
	default:	s.state = 241; break;
	}
}
...
private static void case245(Dbx_scanner s) {
	...
	switch (s.yych) {
	case 'L':
	case 'l':	s.state = 414; break;
	case 'N':
	case 'n':	s.state = 415; break;
	default:	s.state = 56; break;
	}
}
...
private static void case246(Dbx_scanner s) {
	...
	switch (s.yych) {
	case 'R':
	case 'r':	s.state = 416; break;
	case 'Y':
	case 'y':	s.state = 243; break;
	default:	s.state = 56; break;
	}
}
...
private static void case247(Dbx_scanner s) {
	...
	switch (s.yych) {
	case 'C':
	case 'c':	s.state = 417; break;
	case 'L':
	case 'l':	s.state = 418; break;
	case 'N':
	case 'n':	s.state = 419; break;
	default:	s.state = 56; break;
	}
}
...
private static void case249(Dbx_scanner s) {
	...
	switch (s.yych) {
	case 'E':
	case 'e':	s.state = 421; break;
	default:	s.state = 250; break;
	}
}
...
private static void case254(Dbx_scanner s) {
	...
	switch (s.yych) {
	case 'C':
	case 'c':	s.state = 424; break;
	case 'P':
	case 'p':	s.state = 425; break;
	default:	s.state = 56; break;
	}
}
...
private static void case259(Dbx_scanner s) {
	...
	switch (s.yych) {
	case 'D':
	case 'd':	s.state = 428; break;
	case 'E':
	case 'e':	s.state = 429; break;
	default:	s.state = 56; break;
	}
}
...
private static void case264(Dbx_scanner s) {
	...
	case '7':
	case '8':
	case '9':	s.state = 432; break;
	case ':':	s.state = 433; break;
	default:	s.state = 209; break;
	}
}
...
private static void case272(Dbx_scanner s) {
	...
	case 0x00:
	case '\t':
	case ' ':	s.state = 436; break;
	case '.':	s.state = 438; break;
	default:	s.state = 56; break;
	}
}
...
private static void case274(Dbx_scanner s) {
	s.yych = s.src[++s.cursor];
	switch (s.yych) {
	case '0':	s.state = 439; break;
	case '1':	s.state = 440; break;
	case '2':
	case '3':
	case '4':
	case '5':
	...
	case '7':
	case '8':
	case '9':	s.state = 441; break;
	case 'A':
	case 'a':	s.state = 442; break;
	case 'D':
	case 'd':	s.state = 443; break;
	case 'F':
	case 'f':	s.state = 444; break;
	case 'J':
	case 'j':	s.state = 445; break;
	case 'M':
	case 'm':	s.state = 446; break;
	case 'N':
	case 'n':	s.state = 447; break;
	case 'O':
	case 'o':	s.state = 448; break;
	case 'S':
	case 's':	s.state = 449; break;
	default:	s.state = 56; break;
	}
}
...
private static void case279(Dbx_scanner s) {
	...
	case 'z':	s.state = 451; break;
	case 'I':
	case 'i':	s.state = 453; break;
	default:	s.state = 280; break;
	}
}
...
private static void case299(Dbx_scanner s) {
	...
	case 'z':	s.state = 451; break;
	case 'D':
	case 'd':	s.state = 473; break;
	default:	s.state = 300; break;
	}
}
...
private static void case309(Dbx_scanner s) {
	...
	s.ptr = ++s.cursor; s.yych = s.src[s.cursor];
	switch (s.yych) {
	case '0':	s.state = 482; break;
	case '1':	s.state = 483; break;
	case '2':	s.state = 484; break;
	case '3':
	case '4':
	case '5':
	case '6':
	case '7':
	case '8':
	case '9':	s.state = 485; break;
	case 'T':
	case 't':	s.state = 486; break;
	default:	s.state = 310; break;
	}
}
...
private static void case312(Dbx_scanner s) {
	...
	case 'r':
	case 's':
	case 't':	s.state = 311; break;
	case '0':	s.state = 487; break;
	case '1':	s.state = 488; break;
	case '2':	s.state = 489; break;
	case '3':
	case '4':
	case '5':
	case '6':
...
private static void case314(Dbx_scanner s) {
	...
	s.ptr = ++s.cursor; s.yych = s.src[s.cursor];
	switch (s.yych) {
	case 'd':	s.state = 492; break;
	default:	s.state = 312; break;
	}
}
...
private static void case353(Dbx_scanner s) {
	...
	case 'z':	s.state = 451; break;
	case 'R':
	case 'r':	s.state = 521; break;
	case 'S':
	case 's':	s.state = 503; break;
	default:	s.state = 18; break;
	}
}
...
private static void case359(Dbx_scanner s) {
	...
	case 'y':
	case 'z':	s.state = 457; break;
	case 'r':	s.state = 527; break;
	case 's':	s.state = 506; break;
	default:	s.state = 18; break;
	}
}
...
private static void case379(Dbx_scanner s) {
	...
	case '0':
	case '1':
	case '2':	s.state = 544; break;
	case '3':	s.state = 546; break;
	case '4':
	case '5':
	case '6':
	case '7':
	case '8':
	case '9':	s.state = 547; break;
	default:	s.state = 56; break;
	}
}
...
private static void case381(Dbx_scanner s) {
	...
	case '3':
	case '4':
	case '5':	s.state = 548; break;
	case '6':	s.state = 549; break;
	case '7':
	case '8':
	case '9':	s.state = 550; break;
	default:	s.state = 56; break;
	}
}
...
private static void case382(Dbx_scanner s) {
	...
	case '3':
	case '4':
	case '5':	s.state = 551; break;
	case '6':	s.state = 552; break;
	case '7':
	case '8':
	case '9':	s.state = 553; break;
	default:	s.state = 56; break;
	}
}
...
private static void case399(Dbx_scanner s) {
	s.yych = s.src[++s.cursor];
	switch (s.yych) {
	case '0':	s.state = 559; break;
	case '1':	s.state = 560; break;
	case '2':
	case '3':
	case '4':
	case '5':
...
private static void case400(Dbx_scanner s) {
	...
	case 'w':
	case 'y':
	case 0xC2:	s.state = 562; break;
	case '-':	s.state = 563; break;
	case '.':	s.state = 564; break;
	case '/':	s.state = 565; break;
	case '0':	s.state = 566; break;
	case '1':	s.state = 567; break;
	case '2':	s.state = 568; break;
	case '3':	s.state = 569; break;
	case '4':
	case '5':	s.state = 570; break;
	case '6':	s.state = 571; break;
	case '7':
	case '8':
	case '9':	s.state = 57; break;
	case ':':	s.state = 572; break;
	case 'W':	s.state = 584; break;
	default:	s.state = 401; break;
	}
}
...
private static void case402(Dbx_scanner s) {
	...
	case '.':	s.state = 564; break;
	case '/':	s.state = 565; break;
	case '0':	s.state = 586; break;
	case '1':	s.state = 587; break;
	case '2':	s.state = 588; break;
	case '3':	s.state = 589; break;
	case '4':
	case '5':
	case '6':
	case '7':
...
private static void case430(Dbx_scanner s) {
	s.yych = s.src[++s.cursor];
	switch (s.yych) {
	case '0':	s.state = 611; break;
	case '1':	s.state = 612; break;
	case '2':
	case '3':
	case '4':
	case '5':
...
private static void case431(Dbx_scanner s) {
	...
	case '3':
	case '4':
	case '5':	s.state = 614; break;
	case '6':	s.state = 615; break;
	case '7':
	case '8':
	case '9':	s.state = 550; break;
	default:	s.state = 56; break;
...
private static void case433(Dbx_scanner s) {
	...
	case '3':
	case '4':
	case '5':	s.state = 618; break;
	case '6':	s.state = 619; break;
	case '7':
	case '8':
	case '9':	s.state = 553; break;
	default:	s.state = 56; break;
...
private static void case442(Dbx_scanner s) {
	...
	switch (s.yych) {
	case 'P':
	case 'p':	s.state = 623; break;
	case 'U':
	case 'u':	s.state = 624; break;
	default:	s.state = 56; break;
	}
}
...
private static void case445(Dbx_scanner s) {
	...
	switch (s.yych) {
	case 'A':
	case 'a':	s.state = 627; break;
	case 'U':
	case 'u':	s.state = 628; break;
	default:	s.state = 56; break;
	}
}
...
private static void case452(Dbx_scanner s) {
	...
	case '0':
	case '1':
	case '2':	s.state = 635; break;
	case '3':	s.state = 636; break;
	default:	s.state = 136; break;
	}
}
...
private static void case481(Dbx_scanner s) {
	...
	switch (s.yych) {
	case '0':
	case '1':	s.state = 661; break;
	case '2':	s.state = 662; break;
	case '3':
	case '4':
	case '5':
	case '6':
...
private static void case482(Dbx_scanner s) {
	...
	switch (s.yych) {
	case '.':
	case ':':	s.state = 664; break;
	case '0':	s.state = 665; break;
	case '1':
	case '2':
	case '3':
	case '4':
...
private static void case483(Dbx_scanner s) {
	...
	switch (s.yych) {
	case '.':
	case ':':	s.state = 666; break;
	case '0':
	case '1':
	case '2':	s.state = 485; break;
	case '3':
	case '4':
	case '5':
	case '6':
...
private static void case486(Dbx_scanner s) {
	...
	switch (s.yych) {
	case '0':
	case '1':	s.state = 667; break;
	case '2':	s.state = 668; break;
	case '3':
	case '4':
	case '5':
	case '6':
...
private static void case489(Dbx_scanner s) {
	...
	case '2':
	case '3':
	case '4':	s.state = 669; break;
	case '5':
	case '6':
	case '7':
	case '8':
	case '9':	s.state = 671; break;
	default:	s.state = 310; break;
	}
}
...
private static void case497(Dbx_scanner s) {
	...
	s.ptr = ++s.cursor; s.yych = s.src[s.cursor];
	switch (s.yych) {
	case '\t':	s.state = 677; break;
	case ' ':	s.state = 679; break;
	case ')':	s.state = 109; break;
	case 'A':
	case 'B':
	case 'C':
...
private static void case544(Dbx_scanner s) {
	...
	case '7':
	case '8':
	case '9':	s.state = 712; break;
	case 'n':
	case 'r':	s.state = 713; break;
	case 's':	s.state = 714; break;
	case 't':	s.state = 715; break;
	default:	s.state = 545; break;
	}
}
...
private static void case562(Dbx_scanner s) {
	switch (s.yych) {
	case '\t':
	case ' ':	s.state = 561; break;
	case '-':
	case '.':	s.state = 721; break;
	case 'A':
	case 'a':	s.state = 573; break;
	case 'D':
	case 'd':	s.state = 574; break;
	case 'F':
	case 'f':	s.state = 575; break;
	case 'H':
	case 'h':	s.state = 76; break;
	case 'I':	s.state = 576; break;
	case 'J':
	case 'j':	s.state = 578; break;
	case 'M':
	case 'm':	s.state = 579; break;
	case 'N':
	case 'n':	s.state = 580; break;
	case 'O':
	case 'o':	s.state = 581; break;
	case 'S':
	case 's':	s.state = 582; break;
	case 'T':
	case 't':	s.state = 84; break;
	case 'U':
	case 'u':	s.state = 85; break;
	case 'V':	s.state = 583; break;
	case 'W':
	case 'w':	s.state = 87; break;
	case 'X':	s.state = 585; break;
	case 'Y':
	case 'y':	s.state = 89; break;
	case 0xC2:	s.state = 94; break;
	default:	s.state = 56; break;
...
private static void case563(Dbx_scanner s) {
	s.yych = s.src[++s.cursor];
	switch (s.yych) {
	case '0':	s.state = 723; break;
	case '1':	s.state = 725; break;
	case '2':
	case '3':
	case '4':
	case '5':
	...
	case '7':
	case '8':
	case '9':	s.state = 726; break;
	case 'A':
	case 'a':	s.state = 727; break;
	case 'D':
	case 'd':	s.state = 728; break;
	case 'F':
	case 'f':	s.state = 729; break;
	case 'J':
	case 'j':	s.state = 730; break;
	case 'M':
	case 'm':	s.state = 731; break;
	case 'N':
	case 'n':	s.state = 732; break;
	case 'O':
	case 'o':	s.state = 733; break;
	case 'S':
	case 's':	s.state = 734; break;
	case 'W':	s.state = 735; break;
	default:	s.state = 722; break;
	}
}
...
private static void case564(Dbx_scanner s) {
	s.yych = s.src[++s.cursor];
	switch (s.yych) {
	case '0':	s.state = 736; break;
	case '1':
	case '2':	s.state = 737; break;
	case '3':	s.state = 738; break;
	default:	s.state = 722; break;
	}
}
...
private static void case565(Dbx_scanner s) {
	s.yych = s.src[++s.cursor];
	switch (s.yych) {
	case '0':	s.state = 743; break;
	case '1':	s.state = 744; break;
	case '2':
	case '3':
	case '4':
	case '5':
...
private static void case569(Dbx_scanner s) {
	...
	case '3':
	case '4':
	case '5':	s.state = 749; break;
	case '6':	s.state = 750; break;
	case '7':
	case '8':
	case '9':	s.state = 751; break;
	default:	s.state = 187; break;
	}
}
...
private static void case572(Dbx_scanner s) {
	s.yych = s.src[++s.cursor];
	switch (s.yych) {
	case '0':	s.state = 752; break;
	case '1':	s.state = 753; break;
	default:	s.state = 56; break;
	}
}
...
private static void case573(Dbx_scanner s) {
	...
	switch (s.yych) {
	case 'P':
	case 'p':	s.state = 754; break;
	case 'U':
	case 'u':	s.state = 755; break;
	default:	s.state = 56; break;
	}
}
...
private static void case576(Dbx_scanner s) {
	s.yych = s.src[++s.cursor];
	switch (s.yych) {
	case 'I':	s.state = 758; break;
	case 'V':
	case 'X':	s.state = 759; break;
	default:	s.state = 577; break;
	}
}
...
private static void case578(Dbx_scanner s) {
	...
	switch (s.yych) {
	case 'A':
	case 'a':	s.state = 760; break;
	case 'U':
	case 'u':	s.state = 761; break;
	default:	s.state = 56; break;
	}
}
...
private static void case584(Dbx_scanner s) {
	s.yych = s.src[++s.cursor];
	switch (s.yych) {
	case '0':	s.state = 766; break;
	case '1':
	case '2':
	case '3':
	case '4':	s.state = 767; break;
	case '5':	s.state = 768; break;
	case 'E':
	case 'e':	s.state = 259; break;
	default:	s.state = 56; break;
	}
...
private static void case589(Dbx_scanner s) {
	...
	case '3':
	case '4':
	case '5':	s.state = 771; break;
	case '6':	s.state = 772; break;
	case '7':
	case '8':
	case '9':	s.state = 57; break;
	default:	s.state = 187; break;
...
private static void case595(Dbx_scanner s) {
	...
	switch (s.yych) {
	case 'H':
	case 'h':	s.state = 774; break;
	case 'N':
	case 'n':	s.state = 775; break;
	default:	s.state = 56; break;
	}
}
...
private static void case620(Dbx_scanner s) {
	...
	case '3':
	case '4':
	case '5':	s.state = 785; break;
	case '6':	s.state = 786; break;
	case '7':
	case '8':
	case '9':	s.state = 553; break;
	default:	s.state = 56; break;
...
private static void case621(Dbx_scanner s) {
	...
	case '0':
	case '1':
	case '2':	s.state = 787; break;
	case '3':	s.state = 788; break;
	case '4':
	case '5':
	case '6':
	case '7':
	case '8':
	case '9':	s.state = 789; break;
	default:	s.state = 56; break;
	}
}
...
private static void case664(Dbx_scanner s) {
	...
	case '3':
	case '4':
	case '5':	s.state = 813; break;
	case '6':
	case '7':
	case '8':
	case '9':	s.state = 815; break;
	default:	s.state = 56; break;
	}
}
...
private static void case666(Dbx_scanner s) {
	...
	case '3':
	case '4':
	case '5':	s.state = 816; break;
	case '6':
	case '7':
	case '8':
	case '9':	s.state = 817; break;
	default:	s.state = 56; break;
	}
}
...
private static void case678(Dbx_scanner s) {
	...
	case ' ':	s.state = 677; break;
	case 'D':
	case 'd':	s.state = 821; break;
	case 'F':
	case 'f':	s.state = 822; break;
	case 'H':
	case 'h':	s.state = 823; break;
	case 'M':
	case 'm':	s.state = 824; break;
	case 'S':
	case 's':	s.state = 825; break;
	case 'T':
	case 't':	s.state = 826; break;
	case 'U':
	case 'u':	s.state = 827; break;
	case 'W':
	case 'w':	s.state = 828; break;
	case 'Y':
	case 'y':	s.state = 829; break;
	case 0xC2:	s.state = 830; break;
	default:	s.state = 56; break;
	}
}
...
private static void case679(Dbx_scanner s) {
	...
	switch (s.yych) {
	case 'D':
	case 'd':	s.state = 831; break;
	default:	s.state = 678; break;
	}
}
...
private static void case694(Dbx_scanner s) {
	...
	case '3':
	case '4':
	case '5':	s.state = 844; break;
	case '6':	s.state = 845; break;
	default:	s.state = 401; break;
	}
}
...
private static void case708(Dbx_scanner s) {
	s.yych = s.src[++s.cursor];
	switch (s.yych) {
	case '0':	s.state = 856; break;
	case '1':	s.state = 857; break;
	default:	s.state = 56; break;
	}
}
...
private static void case720(Dbx_scanner s) {
	...
	case '0':
	case '1':
	case '2':	s.state = 864; break;
	case '3':	s.state = 865; break;
	case '4':
	case '5':
	case '6':
	case '7':
...
private static void case722(Dbx_scanner s) {
	...
	case 'a':	s.state = 573; break;
	case 'D':
	case 'd':	s.state = 739; break;
	case 'F':
	case 'f':	s.state = 740; break;
	case 'I':	s.state = 576; break;
	case 'J':
	case 'j':	s.state = 578; break;
	case 'M':
	case 'm':	s.state = 741; break;
	case 'N':
	case 'n':	s.state = 580; break;
	case 'O':
	case 'o':	s.state = 581; break;
	case 'S':
	case 's':	s.state = 742; break;
	case 'V':	s.state = 583; break;
	case 'X':	s.state = 585; break;
	default:	s.state = 56; break;
	}
...
private static void case723(Dbx_scanner s) {
	...
	case '7':
	case '8':
	case '9':	s.state = 867; break;
	default:	s.state = 724; break;
	}
}
...
private static void case727(Dbx_scanner s) {
	...
	switch (s.yych) {
	case 'P':
	case 'p':	s.state = 868; break;
	case 'U':
	case 'u':	s.state = 869; break;
	default:	s.state = 56; break;
	}
}
...
private static void case730(Dbx_scanner s) {
	...
	switch (s.yych) {
	case 'A':
	case 'a':	s.state = 872; break;
	case 'U':
	case 'u':	s.state = 873; break;
	default:	s.state = 56; break;
	}
}
...
private static void case738(Dbx_scanner s) {
	...
	case '3':
	case '4':
	case '5':	s.state = 879; break;
	case '6':	s.state = 880; break;
	default:	s.state = 56; break;
	}
}
...
private static void case746(Dbx_scanner s) {
	...
	case 'y':
	case 0xC2:	s.state = 187; break;
	case '0':	s.state = 884; break;
	case '1':
	case '2':	s.state = 885; break;
	case '3':	s.state = 887; break;
	case '4':
	case '5':
	case '6':
	case '7':
	case '8':
	case '9':	s.state = 888; break;
	default:	s.state = 747; break;
	}
}
...
private static void case761(Dbx_scanner s) {
	...
	switch (s.yych) {
	case 'L':
	case 'l':	s.state = 895; break;
	case 'N':
	case 'n':	s.state = 896; break;
	default:	s.state = 56; break;
	}
}
...
private static void case762(Dbx_scanner s) {
	...
	switch (s.yych) {
	case 'R':
	case 'r':	s.state = 897; break;
	case 'Y':
	case 'y':	s.state = 759; break;
	default:	s.state = 56; break;
	}
}
...
private static void case790(Dbx_scanner s) {
	...
	case '0':
	case '1':
	case '2':	s.state = 907; break;
	case '3':	s.state = 908; break;
	case '4':
	case '5':
	case '6':
	case '7':
...
private static void case822(Dbx_scanner s) {
	...
	switch (s.yych) {
	case 'O':
	case 'o':	s.state = 929; break;
	case 'R':
	case 'r':	s.state = 930; break;
	default:	s.state = 56; break;
	}
}
...
private static void case824(Dbx_scanner s) {
	...
	switch (s.yych) {
	case 'I':
	case 'i':	s.state = 932; break;
	case 'O':
	case 'o':	s.state = 933; break;
	case 'S':
	case 's':	s.state = 934; break;
	default:	s.state = 56; break;
	}
}
...
private static void case825(Dbx_scanner s) {
	...
	switch (s.yych) {
	case 'A':
	case 'a':	s.state = 936; break;
	case 'E':
	case 'e':	s.state = 937; break;
	case 'U':
	case 'u':	s.state = 938; break;
	default:	s.state = 56; break;
	}
}
...
private static void case826(Dbx_scanner s) {
	...
	switch (s.yych) {
	case 'H':
	case 'h':	s.state = 939; break;
	case 'U':
	case 'u':	s.state = 940; break;
	default:	s.state = 56; break;
	}
}
...
private static void case866(Dbx_scanner s) {
	...
	case '0':
	case '1':
	case '2':	s.state = 974; break;
	case '3':	s.state = 975; break;
	case '4':
	case '5':
	case '6':
	case '7':
	case '8':
	case '9':	s.state = 976; break;
	default:	s.state = 56; break;
	}
}
...
private static void case873(Dbx_scanner s) {
	...
	switch (s.yych) {
	case 'L':
	case 'l':	s.state = 983; break;
	case 'N':
	case 'n':	s.state = 984; break;
	default:	s.state = 56; break;
	}
}
...
private static void case874(Dbx_scanner s) {
	...
	switch (s.yych) {
	case 'R':
	case 'r':	s.state = 985; break;
	case 'Y':
	case 'y':	s.state = 986; break;
	default:	s.state = 56; break;
	}
}
...
private static void case882(Dbx_scanner s) {
	...
	case '0':
	case '1':
	case '2':	s.state = 990; break;
	case '3':	s.state = 992; break;
	case '4':
	case '5':
	case '6':
	case '7':
	case '8':
	case '9':	s.state = 993; break;
	default:	s.state = 56; break;
	}
}
...
private static void case900(Dbx_scanner s) {
	...
	case '5':
	case '6':
	case '7':	s.state = 1006; break;
	default:	s.state = 901; break;
	}
}
...
private static void case906(Dbx_scanner s) {
	...
	case '\t':
	case ' ':	s.state = 616; break;
	case '.':	s.state = 1010; break;
	case ':':	s.state = 1011; break;
	case 'A':
	case 'P':
	case 'a':
	case 'p':	s.state = 102; break;
...
private static void case909(Dbx_scanner s) {
	...
	case '0':
	case '1':
	case '2':	s.state = 1013; break;
	case '3':	s.state = 1014; break;
	default:	s.state = 56; break;
	}
}
...
private static void case922(Dbx_scanner s) {
	...
	case '3':
	case '4':
	case '5':	s.state = 1020; break;
	case '6':	s.state = 1021; break;
	case '7':
	case '8':
	case '9':	s.state = 1022; break;
	default:	s.state = 56; break;
	}
}
...
private static void case923(Dbx_scanner s) {
	...
	case '3':
	case '4':
	case '5':	s.state = 1023; break;
	case '6':	s.state = 1024; break;
	case '7':
	case '8':
	case '9':	s.state = 1022; break;
	default:	s.state = 56; break;
...
private static void case924(Dbx_scanner s) {
	...
	switch (s.yych) {
	case '\t':
	case ' ':	s.state = 1025; break;
	case '.':
	case ':':	s.state = 923; break;
	case 'A':
	case 'P':
	case 'a':
	case 'p':	s.state = 1027; break;
	default:	s.state = 814; break;
	}
}
...
private static void case932(Dbx_scanner s) {
	...
	switch (s.yych) {
	case 'C':
	case 'c':	s.state = 1032; break;
	case 'L':
	case 'l':	s.state = 1033; break;
	case 'N':
	case 'n':	s.state = 1034; break;
	default:	s.state = 56; break;
	}
}
...
private static void case934(Dbx_scanner s) {
	...
	switch (s.yych) {
	case 'E':
	case 'e':	s.state = 1036; break;
	default:	s.state = 935; break;
	}
}
...
private static void case942(Dbx_scanner s) {
	...
	switch (s.yych) {
	case 'D':
	case 'd':	s.state = 1041; break;
	case 'E':
	case 'e':	s.state = 1042; break;
	default:	s.state = 56; break;
	}
}
...
private static void case974(Dbx_scanner s) {
	...
	case '8':
	case '9':	s.state = 976; break;
	case 'T':	s.state = 1055; break;
	case 'n':
	case 'r':	s.state = 1056; break;
	case 's':	s.state = 1057; break;
	case 't':	s.state = 1058; break;
	default:	s.state = 545; break;
	}
}
...
private static void case977(Dbx_scanner s) {
	...
	case '0':
	case '1':
	case '2':	s.state = 1059; break;
	case '3':	s.state = 1060; break;
	case '4':
	case '5':
	case '6':
	case '7':
...
private static void case990(Dbx_scanner s) {
	...
	case '9':	s.state = 993; break;
	case 'n':
	case 'r':	s.state = 1061; break;
	case 's':	s.state = 1062; break;
	case 't':	s.state = 1063; break;
	default:	s.state = 991; break;
	}
}
...
private static void case994(Dbx_scanner s) {
	...
	case '0':
	case '1':
	case '2':	s.state = 1064; break;
	case '3':	s.state = 1065; break;
	case '4':
	case '5':
	case '6':
	case '7':
...
private static void case995(Dbx_scanner s) {
	...
	case 'Y':
	case 'y':	s.state = 89; break;
	case 't':	s.state = 1067; break;
	case 0xC2:	s.state = 94; break;
	default:	s.state = 996; break;
	}
}
...
private static void case997(Dbx_scanner s) {
	...
	case '0':
	case '1':
	case '2':	s.state = 1068; break;
	case '3':	s.state = 1069; break;
	default:	s.state = 56; break;
	}
}
...
private static void case1016(Dbx_scanner s) {
	...
	case '7':
	case '8':
	case '9':	s.state = 1083; break;
	default:	s.state = 1017; break;
	}
}
...
private static void case1018(Dbx_scanner s) {
	...
	switch (s.yych) {
	case '0':
	case '1':	s.state = 1084; break;
	case '2':	s.state = 1086; break;
	case '3':
	case '4':
	case '5':
	case '6':
...
private static void case1027(Dbx_scanner s) {
	s.yych = s.src[++s.cursor];
	switch (s.yych) {
	case '.':	s.state = 1091; break;
	case 'M':
	case 'm':	s.state = 1092; break;
	default:	s.state = 56; break;
	}
}
...
private static void case1030(Dbx_scanner s) {
	...
	switch (s.yych) {
	case '\t':
	case ' ':	s.state = 1095; break;
	case 'D':
	case 'd':	s.state = 1097; break;
	default:	s.state = 935; break;
	}
}
...
private static void case1053(Dbx_scanner s) {
	...
	case '0':
	case '1':
	case '2':	s.state = 1113; break;
	case '3':	s.state = 1114; break;
	default:	s.state = 56; break;
	}
}
...
private static void case1055(Dbx_scanner s) {
	...
	switch (s.yych) {
	case '0':
	case '1':	s.state = 1116; break;
	case '2':	s.state = 1117; break;
	case '3':
	case '4':
	case '5':
	case '6':
...
private static void case1066(Dbx_scanner s) {
	...
	switch (s.yych) {
	case '0':
	case '1':	s.state = 1123; break;
	case '2':	s.state = 1124; break;
	case '3':
	case '4':
	case '5':
	case '6':
...
private static void case1067(Dbx_scanner s) {
	...
	switch (s.yych) {
	case '0':
	case '1':	s.state = 1126; break;
	case '2':	s.state = 1127; break;
	case '3':
	case '4':
	case '5':
	case '6':
...
private static void case1084(Dbx_scanner s) {
	...
	case 'P':
	case 'a':
	case 'p':	s.state = 1136; break;
	default:	s.state = 1085; break;
	}
}
...
private static void case1092(Dbx_scanner s) {
	...
	case 0x00:
	case '\t':
	case ' ':	s.state = 1149; break;
	case '.':	s.state = 1151; break;
	default:	s.state = 56; break;
	}
}
...
private static void case1094(Dbx_scanner s) {
	...
	switch (s.yych) {
	case 'H':
	case 'h':	s.state = 1152; break;
	case 'N':
	case 'n':	s.state = 1153; break;
	default:	s.state = 56; break;
	}
}
...
private static void case1123(Dbx_scanner s) {
	...
	case '3':
	case '4':
	case '5':	s.state = 1163; break;
	case '6':
	case '7':
	case '8':
	case '9':	s.state = 1125; break;
	case ':':	s.state = 1164; break;
	default:	s.state = 56; break;
	}
}
...
private static void case1124(Dbx_scanner s) {
	...
	case '2':
	case '3':
	case '4':	s.state = 1163; break;
	case '5':	s.state = 1165; break;
	case ':':	s.state = 1164; break;
	default:	s.state = 56; break;
	}
}
...
private static void case1132(Dbx_scanner s) {
	s.yych = s.src[++s.cursor];
	switch (s.yych) {
	case '.':	s.state = 1168; break;
	case 'M':
	case 'm':	s.state = 1169; break;
	default:	s.state = 56; break;
	}
}
...
private static void case1136(Dbx_scanner s) {
	s.yych = s.src[++s.cursor];
	switch (s.yych) {
	case '.':	s.state = 1171; break;
	case 'M':
	case 'm':	s.state = 1172; break;
	default:	s.state = 56; break;
	}
}
...
private static void case1139(Dbx_scanner s) {
	switch (s.yych) {
	case '\t':
	case ' ':	s.state = 1138; break;
	case '(':	s.state = 1140; break;
	case '+':
	case '-':	s.state = 1141; break;
	case 'A':
	case 'B':
	case 'C':
	case 'D':
	...
	case 'X':
	case 'Y':
	case 'Z':	s.state = 1142; break;
	case 'G':	s.state = 1143; break;
	case 'a':
	case 'b':
	case 'c':
	case 'd':
...
private static void case1141(Dbx_scanner s) {
	...
	switch (s.yych) {
	case '0':
	case '1':	s.state = 1173; break;
	case '2':	s.state = 1174; break;
	case '3':
	case '4':
	case '5':
	case '6':
...
private static void case1146(Dbx_scanner s) {
	switch (s.yych) {
	case '\t':
	case ' ':	s.state = 1145; break;
	case '(':	s.state = 1140; break;
	case '+':
	case '-':	s.state = 1141; break;
	case 'A':
	case 'P':	s.state = 1147; break;
	case 'B':
	case 'C':
	case 'D':
	case 'E':
...
private static void case1160(Dbx_scanner s) {
	...
	switch (s.yych) {
	case '0':
	case '1':	s.state = 1188; break;
	case '2':	s.state = 1189; break;
	default:	s.state = 56; break;
	}
}
...
private static void case1161(Dbx_scanner s) {
	...
	case '3':
	case '4':
	case '5':	s.state = 1190; break;
	case '6':
	case '7':
	case '8':
	case '9':	s.state = 1191; break;
	default:	s.state = 56; break;
	}
}
...
private static void case1162(Dbx_scanner s) {
	...
	switch (s.yych) {
	case '0':
	case '1':	s.state = 1192; break;
	case '2':	s.state = 1193; break;
	case '3':
	case '4':
	case '5':
	case '6':
...
private static void case1163(Dbx_scanner s) {
	...
	case '3':
	case '4':
	case '5':	s.state = 1194; break;
	case '6':
	case '7':
	case '8':
	case '9':	s.state = 1195; break;
	case ':':	s.state = 1164; break;
	default:	s.state = 56; break;
	}
}
...
private static void case1167(Dbx_scanner s) {
	...
	switch (s.yych) {
	case '0':
	case '1':	s.state = 1197; break;
	case '2':	s.state = 1198; break;
	default:	s.state = 56; break;
	}
}
...
private static void case1169(Dbx_scanner s) {
	...
	case 0x00:
	case '\t':
	case ' ':	s.state = 1199; break;
	case '.':	s.state = 1201; break;
	default:	s.state = 56; break;
	}
}
...
private static void case1172(Dbx_scanner s) {
	...
	case 0x00:
	case '\t':
	case ' ':	s.state = 1202; break;
	case '.':	s.state = 1203; break;
	default:	s.state = 56; break;
	}
}
...
private static void case1174(Dbx_scanner s) {
	...
	case '2':
	case '3':
	case '4':	s.state = 1175; break;
	case '5':	s.state = 1205; break;
	case '6':
	case '7':
	case '8':
	case '9':	s.state = 1022; break;
...
private static void case1194(Dbx_scanner s) {
	...
	case '3':
	case '4':
	case '5':	s.state = 1213; break;
	case '6':	s.state = 1215; break;
	case '7':
	case '8':
	case '9':	s.state = 1195; break;
	default:	s.state = 56; break;
...
private static void case1195(Dbx_scanner s) {
	...
	case '3':
	case '4':
	case '5':	s.state = 1216; break;
	case '6':	s.state = 1217; break;
	default:	s.state = 56; break;
	}
}
...
private static void case1213(Dbx_scanner s) {
	...
	case '3':
	case '4':
	case '5':	s.state = 1227; break;
	case '6':	s.state = 1229; break;
	case '7':
	case '8':
	case '9':	s.state = 1230; break;
	default:	s.state = 56; break;
	}
}
...
private static void case1242(Dbx_scanner s) {
	...
	case '3':
	case '4':
	case '5':	s.state = 1244; break;
	case '6':	s.state = 1245; break;
	default:	s.state = 56; break;
	}
}
...
private static void case1243(Dbx_scanner s) {
	...
	case '3':
	case '4':
	case '5':	s.state = 1246; break;
	case '6':	s.state = 1247; break;
	case '7':
	case '8':
	case '9':	s.state = 1230; break;
	default:	s.state = 56; break;
...
private static void case1250(Dbx_scanner s) {
	...
	case ' ':	s.state = 1250; break;
	case '+':
	case '-':	s.state = 1253; break;
	case 'G':	s.state = 1254; break;
	default:	s.state = 56; break;
	}
}
...
private static void case1253(Dbx_scanner s) {
	...
	switch (s.yych) {
	case '0':
	case '1':	s.state = 1257; break;
	case '2':	s.state = 1259; break;
	case '3':
	case '4':
	case '5':
	case '6':
...
private static void case1257(Dbx_scanner s) {
	...
	case '8':
	case '9':	s.state = 1260; break;
	case ':':	s.state = 1264; break;
	default:	s.state = 1258; break;
	}
}
...
private static void case1259(Dbx_scanner s) {
	...
	case '2':
	case '3':
	case '4':	s.state = 1260; break;
	case '5':	s.state = 1265; break;
	case '6':
	case '7':
	case '8':
	case '9':	s.state = 1266; break;
	case ':':	s.state = 1264; break;
	default:	s.state = 1258; break;
	}
}
...
private static void case1262(Dbx_scanner s) {
	...
	switch (s.yych) {
	case '0':
	case '1':	s.state = 1268; break;
	case '2':	s.state = 1269; break;
	case '3':
	case '4':
	case '5':
	case '6':
