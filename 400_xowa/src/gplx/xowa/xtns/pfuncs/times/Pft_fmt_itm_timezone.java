...
class Pft_fmt_itm_timezone_offset_4 implements Pft_fmt_itm {
	...
	public int TypeId() {return colon ? Pft_fmt_itm_.Tid_timezone_offset_4_colon : Pft_fmt_itm_.Tid_timezone_offset_4;}
...
class Pft_fmt_itm_timezone_id implements Pft_fmt_itm {
	private boolean abrv;
	public Pft_fmt_itm_timezone_id(boolean abrv) {this.abrv = abrv;}
	public int TypeId() {return abrv ? Pft_fmt_itm_.Tid_timezone_id_abrv : Pft_fmt_itm_.Tid_timezone_id_full;}
	public void Fmt(Bry_bfr bfr, Xowe_wiki wiki, Xol_lang_itm lang, DateAdp date, Pft_func_formatdate_bldr bldr) {
		if (abrv)
			bfr.Add( Db_timezone.Get_code(date.Timezone_id(), date.Timezone_offset()) );
		else
