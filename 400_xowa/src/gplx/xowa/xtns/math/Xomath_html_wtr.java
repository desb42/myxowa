...
class Xomath_html_wtr {
	...
	public void Write(Bry_bfr bfr, Xop_ctx ctx, Xop_xnde_tkn xnde, byte[] src, boolean is_latex, boolean enabled, int tkn) {
		// init vars
		...
		Bry_fmt fmt = is_latex ? fmt__latex : xnde.Tag().Id() == Xop_xnde_tag_.Tid__chem ? fmt__chemjax : fmt__mathjax;
