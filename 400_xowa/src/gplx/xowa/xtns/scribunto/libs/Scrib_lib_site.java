...
public class Scrib_lib_site implements Scrib_lib {
	...
	public Scrib_lua_mod Register(Scrib_core core, Io_url script_dir) {
		Init();
		//mod = core.RegisterInterface(this, "mw.site.lua", core.Core_mgr().Get_text(script_dir, "mw.site.lua"));
		mod = core.RegisterInterface(this, "mw.site.lua", core.Fsys_mgr().Get_or_null("mw.site"));
