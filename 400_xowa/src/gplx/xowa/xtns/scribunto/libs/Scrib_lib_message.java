...
public class Scrib_lib_message implements Scrib_lib {
	...
	public Scrib_lua_mod Register(Scrib_core core, Io_url script_dir) {
		Init();
		//mod = core.RegisterInterface(this, "mw.message.lua", core.Core_mgr().Get_text(script_dir, "mw.message.lua"));
		mod = core.RegisterInterface(this, "mw.message.lua", core.Fsys_mgr().Get_or_null("mw.message"));
