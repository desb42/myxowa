...
//		}
	...
	public boolean GetContent(Scrib_proc_args args, Scrib_proc_rslt rslt) {
		...
		return rv == null ? rslt.Init_obj("") : rslt.Init_obj(String_.new_u8(rv)); // NOTE: if content is null, then return null; EX:=mw.title.new('Wikipedia:Recent additions/2099/June'):getContent() DATE:2019-05-08
