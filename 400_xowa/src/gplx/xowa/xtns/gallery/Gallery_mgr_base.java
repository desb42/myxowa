...
class Gallery_mgr_slideshow extends Gallery_mgr_base {
	@Override public byte	Tid()		{return Gallery_mgr_base_.Tid__slideshow;}		
	@Override public void Get_modules(Xoae_page page) {
		super.Get_modules(page);
		page.Html_data().Head_mgr().Itm__gallery_slideshow().Enabled_y_();
	}
}
