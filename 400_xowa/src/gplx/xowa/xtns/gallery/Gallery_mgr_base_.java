...
public class Gallery_mgr_base_ {
	...
	, Bry__slideshow		= Bry_.new_a7("slideshow")
	;
	...
	.Add_bry_byte(Bry__slideshow		, Tid__slideshow)
	;
	...
	public static byte[] To_bry(byte tid) {
		switch (tid) {
			...
			case Tid__slideshow:		return Bry__slideshow;
	...
	public static Gallery_mgr_base New(byte mode) {
		switch (mode) {
			...
			case Tid__slideshow:		return new Gallery_mgr_slideshow();
		}
	}
