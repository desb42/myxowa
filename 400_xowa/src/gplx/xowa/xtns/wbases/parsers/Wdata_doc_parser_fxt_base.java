...
abstract class Wdata_doc_parser_fxt_base {
	...
	public void Test_labels(String raw, Wdata_langtext_itm... expd)		{Test_langvals(raw, Wdata_doc_parser_v2.Bry_labels);}
	public void Test_descriptions(String raw, Wdata_langtext_itm... expd)	{Test_langvals(raw, Wdata_doc_parser_v2.Bry_descriptions);}
	private void Test_langvals(String raw, byte[] langval_key, Wdata_langtext_itm... expd) {
		Ordered_hash actl_hash = wdoc_parser.Parse_langvals(Q1_bry, json_parser.Parse_by_apos(raw), langval_key);
