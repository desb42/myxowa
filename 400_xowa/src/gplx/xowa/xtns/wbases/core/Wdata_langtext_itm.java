...
public class Wdata_langtext_itm implements Wdata_lang_sortable {
	...
	public static Wdata_langtext_itm Get_itm_core_or_any(Ordered_hash list) {
		if (list == null) return null;
		Object itm_obj = list.Get_by(Bry_.new_a7("en"));
		if (itm_obj != null) return (Wdata_langtext_itm)itm_obj;
		return (Wdata_langtext_itm)list.Get_at(0);
	}
}
