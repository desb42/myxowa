...
public class Wdata_hwtr_msgs {
	public Wdata_hwtr_msgs(byte[][] brys) {							 int offset = 0; // String[] strs = String_.Ary(brys); // TEST
		...
		json_div_hdr							= brys[offset +  9]; offset += 10;
	...
	public byte[] Lemma_tbl_hdr() {return lemma_tbl_hdr;} private final    byte[] lemma_tbl_hdr;
	public byte[] Lemma_col_hdr() {return lemma_col_hdr;} private final    byte[] lemma_col_hdr;
	...
	public static Wdata_hwtr_msgs new_en_() {
		...
		, "~{wiki_type}", "other sites", "Linked page"
		, "Labels", "Label"
		, "Aliases", "Alias"
	...
	public static Wdata_hwtr_msgs new_(Xow_msg_mgr msg_mgr) {
		...
		, "parentheses"
		, "wikibase-snakview-snaktypeselector-novalue", "wikibase-snakview-snaktypeselector-somevalue"
		, "jan", "feb", "mar", "apr", "may", "jun", "jul", "aug", "sep", "oct", "nov", "dec"
