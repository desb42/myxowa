...
public class Hxtn_page_wkr__indicators implements Hxtn_page_wkr {
	private final    Hxtn_blob_tbl page_text_tbl;
	public int Id() {return Hxtn_page_mgr.Id__indicators;}
	public String Key() {return "xowa.xtns.indicators";}
	public Hxtn_page_wkr__indicators(Hxtn_blob_tbl page_text_tbl) {
		this.page_text_tbl = page_text_tbl;
	}
	public void Load_by_page(Xoh_page hpg, Xoa_ttl ttl, int page_id) {
		byte[] serial = page_text_tbl.Select_text(Hxtn_blob_tbl.Blob_tid__wtxt, Hxtn_page_mgr.Itm__indicators, page_id);
		hpg.Indicators_serial_(serial);
	}
}
