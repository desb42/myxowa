...
public class Hxtn_page_wkr__related implements Hxtn_page_wkr {
	private final    Hxtn_blob_tbl page_text_tbl;
	public int Id() {return Hxtn_page_mgr.Id__related;}
	public String Key() {return "xowa.xtns.relate";}
	public Hxtn_page_wkr__related(Hxtn_blob_tbl page_text_tbl) {
		this.page_text_tbl = page_text_tbl;
	}
	public void Load_by_page(Xoh_page hpg, Xoa_ttl ttl, int page_id) {
		byte[] related = page_text_tbl.Select_text(Hxtn_blob_tbl.Blob_tid__wtxt, Hxtn_page_mgr.Itm__related, page_id);
		hpg.Related_serial_(related);
	}
}
