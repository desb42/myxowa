...
public class Synh_xtn_nde implements Xox_xnde, Mwh_atr_itm_owner1 {
	...
	private boolean line_enabled = false; private int start = 1; 
        private Int_rng_mgr highlight_idxs = Int_rng_mgr_null.Instance; private boolean highlight_lines = false;
	...
	public void Xatr__set(Xowe_wiki wiki, byte[] src, Mwh_atr_itm xatr, Object xatr_id_obj) {
		...
		switch (xatr_id.Val()) {
			...
			case Xatr_highlight:	highlight_idxs	= new Int_rng_mgr_base(); highlight_idxs.Parse(xatr.Val_as_bry()); highlight_lines = true; break;
		}
	}
	...
	public void Xtn_write(Bry_bfr bfr, Xoae_app app, Xop_ctx ctx, Xoh_html_wtr html_wtr, Xoh_wtr_ctx hctx, Xoae_page wpg, Xop_xnde_tkn xnde, byte[] src) {
		Synh_xtn_nde_.Make(bfr, app, src, xnde.Tag_open_end(), xnde.Tag_close_bgn(), lang, enclose, style, line_enabled, start, highlight_lines, highlight_idxs);
	}
