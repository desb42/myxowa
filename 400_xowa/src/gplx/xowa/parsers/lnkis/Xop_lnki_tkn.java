...
public class Xop_lnki_tkn extends Xop_tkn_itm_base implements gplx.xowa.wikis.pages.lnkis.Xopg_lnki_itm {
	...
	public Arg_nde_tkn		Thumb_alt() {return thumb_alt;} public Xop_lnki_tkn Thumb_alt_(Arg_nde_tkn v) {thumb_alt = v; return this;} Arg_nde_tkn thumb_alt = Arg_nde_tkn.Null;
	...
	public byte[] Target;
	public byte[] Ttl_ary() {
		return ttl.ForceLiteralLink() //202100410 || ns_id != Xow_ns_.Tid__main		// if [[:]] or non-main (Category, Template)
