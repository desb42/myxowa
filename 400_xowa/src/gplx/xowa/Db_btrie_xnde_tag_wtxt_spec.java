...
import gplx.Bry_;
public class Db_btrie_xnde_tag_wtxt_spec implements Db_btrie {
	private final Object[] objs;
	private int found;
	private int offset;
	public Db_btrie_xnde_tag_wtxt_spec(Object[] objs) {this.objs = objs; }
	public static byte[] Hash() { return Bry_.new_a7("d062a65fc0082c3c7d47a1f4191c957e"); }
								...
								case 85:
									if (ofs+5 < src_len && (src[ofs+4] | 32) == 'r' && (src[ofs+5] | 32) == 'e') {
										if (ofs+12 < src_len && src[ofs+6] == '-' && (src[ofs+7] | 32) == 'i' && (src[ofs+8] | 32) == 'n' && (src[ofs+9] | 32) == 'l' && (src[ofs+10] | 32) == 'i' && (src[ofs+11] | 32) == 'n' && (src[ofs+12] | 32) == 'e') {
											found = ofs + 13;
											offset = 119; // ('figure-inline', 119)
										}
										if (found == -1) {
											found = ofs + 6;
											offset = 118; // ('figure', 118)
										}
									}
									break;
							}
							...
							if (ofs+5 < src_len) switch ((src[ofs+5])) {
								...
								case 87:
									if (ofs+14 < src_len && (src[ofs+6] | 32) == 'i' && (src[ofs+7] | 32) == 'k' && (src[ofs+8] | 32) == 'i' && src[ofs+9] == '_' && (src[ofs+10] | 32) == 's' && (src[ofs+11] | 32) == 'e' && (src[ofs+12] | 32) == 't' && (src[ofs+13] | 32) == 'u' && (src[ofs+14] | 32) == 'p') {
										found = ofs + 15;
										offset = 108; // ('xowa_Wiki_setup', 108)
									}
									break;
							}
						}
