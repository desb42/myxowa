...
public class Xowd_data_tstr {
	...
	public void Html__insert(int page_id, String html) {
		...
		byte[] data = html_bry;
		html_db.Tbl__html().Insert(page_id, 0, gplx.core.ios.streams.Io_stream_tid_.Tid__raw, gplx.xowa.htmls.core.hzips.Xoh_hzip_dict_.Hdb__htxt, Bry_.Empty, Bry_.Empty, Bry_.Empty, data, null);
	}
