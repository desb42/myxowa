...
public class Xoa_url {
	...
	public boolean Eq_page(Xoa_url comp) {return Bry_.Eq(wiki_bry, comp.wiki_bry) && Bry_.Eq(page_bry, comp.page_bry) && this.Qargs_mgr().IsNoRedirect() == comp.Qargs_mgr().IsNoRedirect();}
