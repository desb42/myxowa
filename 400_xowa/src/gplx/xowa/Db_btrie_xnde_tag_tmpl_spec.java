...
import gplx.Bry_;
public class Db_btrie_xnde_tag_tmpl_spec implements Db_btrie {
	private final Object[] objs;
	private int found;
	private int offset;
	public Db_btrie_xnde_tag_tmpl_spec(Object[] objs) {this.objs = objs; }
	public static byte[] Hash() { return Bry_.new_a7("cbf10d7c62b2f620941d88ed72e58061"); }
	private void Match_with_b(byte b, byte[] src, int ofs, int src_len) {
		...
		switch (c) {
			...
			case 100:
			case 68:
				if (ofs+14 < src_len && (src[ofs+1] | 32) == 'y' && (src[ofs+2] | 32) == 'n' && (src[ofs+3] | 32) == 'a' && (src[ofs+4] | 32) == 'm' && (src[ofs+5] | 32) == 'i' && (src[ofs+6] | 32) == 'c' && (src[ofs+7] | 32) == 'p' && (src[ofs+8] | 32) == 'a' && (src[ofs+9] | 32) == 'g' && (src[ofs+10] | 32) == 'e' && (src[ofs+11] | 32) == 'l' && (src[ofs+12] | 32) == 'i' && (src[ofs+13] | 32) == 's' && (src[ofs+14] | 32) == 't') {
					found = ofs + 15;
					offset = 21; // ('dynamicPageList', 21)
				}
				break;
			case 103:
			case 71:
