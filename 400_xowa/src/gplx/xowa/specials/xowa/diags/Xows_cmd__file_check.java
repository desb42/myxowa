...
*/
package gplx.xowa.specials.xowa.diags; import gplx.*; import gplx.xowa.*; import gplx.xowa.specials.*;
...
class Xows_cmd__file_check {
	...
	private void Export_bins(Bry_bfr bfr, byte[] file_bry, Object[][] rows, int owner_id_ordinal, int bin_data_ordinal) {
		...
		for (int i = 0; i < rows_len; ++i) {
			...
			file_bry = gplx.xowa.files.repos.Xof_itm_ttl_.Remove_invalid(file_bry);
