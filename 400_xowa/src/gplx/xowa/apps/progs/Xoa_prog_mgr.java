...
public class Xoa_prog_mgr implements Gfo_invk {
	...
	public void Init_by_app(Xoa_app app, Xoa_fsys_eval cmd_eval) {
		...
		Process_adp.ini_(this, usr_dlg, app_convert_svg_to_png		, cmd_eval, Process_adp.Run_mode_sync_timeout	, 10 * 60, "~{<>bin_plat_dir<>}inkscape-1.1.1\\bin\\inkscape", "-w ~{width} -o \"~{target}\" \"~{source}\"", "source", "target", "width").Thread_kill_name_("inkscape.exe");	// // -w=width; o=export-png file
