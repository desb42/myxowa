...
public class Xoa_fsys_mgr implements Gfo_invk {
	public Xoa_fsys_mgr(String plat_name, Io_url root_dir, Io_url wiki_dir, Io_url file_dir, Io_url css_dir, Io_url http_root) {
		...
		this.bin_xowa_file_dir		= bin_xowa_dir.GenSubDir_nest("extra"); // was "file"
	...
	public Io_url Bin_xowa_file_dir()			{return bin_xowa_file_dir;} private final    Io_url bin_xowa_file_dir; // EX: /xowa/bin/any/xowa/extra/
