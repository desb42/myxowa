...
public class Xol_msg_itm {
	...
	public boolean		Has_wtxt()		{return has_wtxt;} private boolean has_wtxt;
	...
	public void Atrs_set(byte[] val, boolean has_fmt_arg, boolean has_tmpl_txt, boolean has_wtxt) {
		this.val = val;
                fmtr.Fmt_(val);
                this.has_fmt_arg = has_fmt_arg;
                this.has_tmpl_txt = has_tmpl_txt;
                this.has_wtxt = has_wtxt;
	}
