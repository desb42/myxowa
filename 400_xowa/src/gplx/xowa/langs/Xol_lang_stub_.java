...
, Id_en_us = 486
	;
	public static final int Id__max = 487;
...
Regy_add(stub_hash, Id_cs, "cs", "‎čeština");
...
Regy_add(stub_hash, Id_no, "no", "‪norsk‬");
...
class Xol_sub_itm_comparer implements ComparerAble {
	public int compare(Object lhsObj, Object rhsObj) {
		...
		Xol_lang_stub rhs = (Xol_lang_stub)rhsObj;
                String s_lhs = String_.new_u8(lhs.Canonical_name());
                String s_rhs = String_.new_u8(rhs.Canonical_name());
                return s_lhs.compareTo(s_rhs);
//                System.out.println(String_.new_u8(lhs.Canonical_name()) +":" +String_.new_u8(rhs.Canonical_name()));
//		return Bry_.Compare(lhs.Canonical_name()/*.Key()*/, rhs.Canonical_name()/*.Key()*/);
	}
}
