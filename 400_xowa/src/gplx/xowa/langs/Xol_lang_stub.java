...
public class Xol_lang_stub {
	public Xol_lang_stub(int id, byte[] key, byte[] canonical_name) {this.id = id; this.key = key; this.canonical_name = canonical_name; this.local_name = null;}
	...
	public byte[]	Local_name() {return local_name;} private byte[] local_name;	// EX: German
	public void	Local_name_(byte[] name) {local_name = name;}
}
