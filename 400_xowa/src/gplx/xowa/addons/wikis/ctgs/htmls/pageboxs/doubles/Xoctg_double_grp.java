...
*/
package gplx.xowa.addons.wikis.ctgs.htmls.pageboxs.doubles; import gplx.*; import gplx.xowa.*; import gplx.xowa.addons.*; import gplx.xowa.addons.wikis.ctgs.*; import gplx.xowa.addons.wikis.ctgs.htmls.*; import gplx.xowa.addons.wikis.ctgs.htmls.pageboxs.*;
...
public class Xoctg_double_grp implements Bfr_arg {
	...
	public void Bfr_arg__add(Bry_bfr bfr) {
		...
		if (type_is_normal) {
			...
			if (wiki.Lang().Lang_id() == Xol_lang_stub_.Id_fr)
				...
				vis = Bry_.new_a7("shown");
			Fmt__hidden.Bld_many(bfr, vis, lbl_hidden, itms);
		}
	}
	...
	( "" 
	, "<div id=\"mw-hidden-catlinks\" class=\"mw-hidden-catlinks mw-hidden-cats-user-~{vis}\">~{hidden_ctg_txt}:"
	,   "<ul>~{grp_itms}"
	,   "</ul>"
	, "</div>"
	);
