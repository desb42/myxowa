...
*/
package gplx.xowa.addons.wikis.searchs.bldrs; import gplx.*; import gplx.xowa.*; import gplx.xowa.addons.*; import gplx.xowa.addons.wikis.searchs.*;
...
public class Srch_bldr_cmd extends Xob_cmd__base implements Xob_cmd {
	...
	@Override public void Cmd_run() {
		if (!gplx.core.envs.Env_.Mode_testing()) wiki.Init_assert(0);
