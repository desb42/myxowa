...
class Xoh_sidebar_parser {	// TS:
	...
	private static final byte Ignore__search = 1, Ignore__toolbox = 2, Ignore__toolbox_end = 3, Ignore__languages = 4, Ignore__print_export = 5;
	...
	.Add_str_byte("coll-print_export"	, Ignore__print_export)
	;
}
