...
*/
package gplx.xowa.addons.bldrs.exports.splits.archives; import gplx.*; import gplx.xowa.*; import gplx.xowa.addons.*; import gplx.xowa.addons.bldrs.exports.*; import gplx.xowa.addons.bldrs.exports.splits.*;
	...
	private void Move_html_data(long trg_db_size_max) {
		...
		try {
			...
			while (rdr.Move_next()) {
				...
				// move row same page_d
				trg_html_tbl.Html_tbl().Insert(src_html_row.Page_id(), src_html_row.Body(), null);
