...
( function () {
	...
	mw.webfonts.preferences = {
		registry: {
			fonts: {},
			webfontsEnabled: true //mw.config.get( 'wgULSWebfontsEnabled' )
		},
	...
	mw.webfonts.setup = function () {
		...
		mediawikiFontRepository.base = xowa.root_dir + 'bin/any/xowa/html/res/lib/ext/data/fontrepo/fonts/'; // mw.config.get( 'wgULSFontRepositoryBasePath' );
	...
	$( function () {
		...
		if ( mw.webfonts.preferences.isEnabled() ) {
			xowa.js.load_lib( xowa.root_dir + 'bin/any/xowa/html/res/lib/ext/ext.uls.webfonts.repository.js', mw.webfonts.setup );
