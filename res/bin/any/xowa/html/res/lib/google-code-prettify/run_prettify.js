!function(){/*
 ...
 limitations under the License.
*/
//var cdn = "https://cdn.rawgit.com/google/code-prettify/master/loader"
var cdn = xowa.root_dir + 'bin/any/xowa/html/res/lib/google-code-prettify';
(function() {
    function aa(g) {
        function r() {
            try {
    ...
    for (B = H.length; l < B; ++l)(function() {
        ...
        g.src = cdn + "/lang-" + encodeURIComponent(H[l]) + ".js";
        N.insertBefore(g, N.firstChild)
    })(H[l]);
    for (var S = H.length, F = [], l = 0, B = P.length; l < B; ++l) F.push(cdn + "/skins/" + encodeURIComponent(P[l]) + ".css");
    F.push(cdn + "/prettify.css");
    (function(g) {
        function r(l) {
            if (l !== x) {
