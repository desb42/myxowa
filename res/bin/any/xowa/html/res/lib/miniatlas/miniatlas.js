// originally from https://meta.wikimedia.org/w/index.php?title=MediaWiki:Wikiminiatlas.js&action=raw&ctype=text/javascript
...
jQuery(function ($) {
 ...
 var wc = {
  ...
  buttonImage: xowa_root_dir + 'bin/any/xowa/html/res/lib/miniatlas/17px-WMA_button2b.png',
  buttonImage2x: xowa_root_dir + 'bin/any/xowa/html/res/lib/miniatlas/34px-WMA_button2b.png'
...
//                '//upload.wikimedia.org/wikipedia/commons/3/30/Button_resize_rtl.png' ];
  var rbrtl = [ '/xowa/fsys/bin/any/xowa/html/res/lib/miniatlas/Button_resize.png',
                '/xowa/fsys/bin/any/xowa/html/res/lib/miniatlas/Button_resize_rtl.png' ];
  ...
  wi.closebutton = $('<img>').attr( {
   ...
   src : '/xowa/fsys/bin/any/xowa/html/res/lib/miniatlas/Button_hide.png'
  } ).css( {
